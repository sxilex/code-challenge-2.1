...
export default async function MaleCharacters() {
  const res = await fetch(
    "https://sensualdrop-us.backendless.app/api/data/Characters?where=genderCategory.gender%3D'Male'&loadRelations=genderCategory"
  );
