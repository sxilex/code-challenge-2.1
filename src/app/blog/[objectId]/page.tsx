        ...
        <section className="mx-auto w-screen min-h-screen bg-black">
          <div className="w-screen h-screen relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 justify-between top-16 absolute">
              ...
              <div className="px-8 pt text-center flex flex-col gap-18 justify-center place-items-center">
                ...
                <span
                  className={`${
                    data.genderCategory?.gender === "Male"
                      ...
                      : "bg-amber-300"
                  } text-lg font-mono border border-black w-fit px-4 bg-amber-300 text-white rounded-3xl py-2`}
                >
